...
<?php
    ...
    $cmd = 'python '. 'dl_csv.py' .' '. escapeshellarg($dtfrom) . ' '. escapeshellarg($path) . ' '. escapeshellarg($mmsis) . ' ' . escapeshellarg($dts_high) . ' ' . escapeshellarg($dts_low) . ' ' . escapeshellarg($span) . ' ' . escapeshellarg($pos1) . ' ' .  escapeshellarg($pos2) . ' ' .  escapeshellarg($save_path) . ' ' .  escapeshellarg($username) . ' ' .  escapeshellarg($csv_type) . ' ' . escapeshellarg($microtime_float);
    //echo $cmd
